...
# TODO: Implement a metaclass that: 1. builds the namedtuple returned type class from fields, and 2. registers all gwas parsers for use by the sniffer
...
class BaseGWASParser(abc.ABC):
    ...
    def sort(self, lazy: bool=True) -> 'BaseGWASParser':
        ...
        with tempfile.TemporaryFile() as f:  # TODO: Sort, write, reopen
            pass
    ...
    def _make_generator(self, iterator) -> typing.Iterable:
        """Process the output of an iterator before returning it"""
        for row in iterator:
